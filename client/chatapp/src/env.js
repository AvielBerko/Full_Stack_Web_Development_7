...
const routes = {
  ...
  getContacts: (options) => options ? `${SERVER_URL}/contacts?${new URLSearchParams(options).toString()}` : `${SERVER_URL}/contacts`,
  ...
  getGroups: (options) => options ?`${SERVER_URL}/groups?${new URLSearchParams(options).toString()}` : `${SERVER_URL}/groups`,
