...
export function getMessages(contactID, options) {
  return get(routes.getMessages(contactID, options));
  // return axios
...
export function sendMessage(contactID, message) {
  return add(routes.sendMessage(contactID), message);
  // return axios
...
export function deleteMessage(contactID, messageId) {
  return remove(routes.deleteMessage(contactID, messageId));
  // return axios
...
export function updateMessage(contactID, message) {
  return update(routes.updateMessage(contactID, message.id), message);
  // return axios
